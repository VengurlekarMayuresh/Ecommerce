      ...
      <DialogContent className="grid grid-cols-2 sm:p-12 max-w-[90vw] sm:max-w-[80vw] lg:max-w-[70vw]">
        ...
        <div className="">
            ...
            <div className="flex items-center justify-between">
                <p className={`text-3xl font-bold text-primary ${ProductDetails?.salesPrice > 0 ? "line-through" : ""}`}>${ProductDetails?.price}</p>
                {ProductDetails?.salesPrice > 0 ? <p className="text-3xl font-bold text-primary">${ProductDetails?.salesPrice}</p> : null}
            </div>
